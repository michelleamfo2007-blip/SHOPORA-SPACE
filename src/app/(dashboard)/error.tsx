...
export default function ErrorBoundary({
  ...
  useEffect(() => {
    console.error("Dashboard layout caught error:", error)
  }, [error])

  return (
    <div className="flex h-screen flex-col items-center justify-center p-8 space-y-4 text-center bg-slate-50">
