            ...
            <div>
              ...
              <div className="flex gap-4">
                {store.instagramHandle && (
                  <a href={store.instagramHandle.startsWith('http') ? store.instagramHandle : `https://instagram.com/${store.instagramHandle.replace('@', '')}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                ...
                {store.tiktokHandle && (
                  <a href={store.tiktokHandle.startsWith('http') ? store.tiktokHandle : `https://tiktok.com/${store.tiktokHandle.startsWith('@') ? store.tiktokHandle : '@' + store.tiktokHandle}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
