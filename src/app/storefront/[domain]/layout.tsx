            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                {store.whatsappNumber && (
                  ...
                  <a href={`https://tiktok.com/${store.tiktokHandle.startsWith('@') ? store.tiktokHandle : '@' + store.tiktokHandle}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                ...
                {store.snapchatHandle && (
                  <a href={`https://snapchat.com/add/${store.snapchatHandle.replace('@', '')}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
